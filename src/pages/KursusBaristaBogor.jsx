      ...
      <main className="bg-dark-charcoal text-white min-h-screen">
        <div className="max-w-5xl mx-auto px-4 py-10">
          ...
          <h1 className="text-4xl font-bold mb-6">
            Kursus Barista Bogor Profesional | Belajar Espresso & Latte Art
          </h1>

          <p className="mb-4">
            Barista Lab Academy menyediakan kursus barista di Bogor untuk pemula,
mahasiswa, karyawan coffee shop, hingga calon pemilik usaha kopi yang
ingin meningkatkan kemampuan di industri kopi modern.
          </p>
          ...
          <p className="mb-4">
            Program ini cocok untuk peserta dari Kota Bogor, Cibinong, Sentul,
Dramaga, dan wilayah Bogor lainnya yang ingin belajar menjadi
barista profesional.  </p>
